    ...
    while True:
        ...
        try:
            ...
            try:
                ...
                # khi het danh sach tai day thi count khong tro ve 0 => periodic khong dc lay het
            except StopIteration:
                return
        
        count += 1
        # khi chay den LOGGED_IN_CHECK_INTERVAL=50 se lay periodic do count = 0. Sau do count +=1 thi lay tiep secound , 
        #. flow la vay. tuy nhien neu secondary <50 thi ctrinh se bi stop va return trc khi chay het
        if count % interval == 0:
            count = 0
