...
from .types           import OutputMethod, Params, Policy, RCEConfidence, UrlType, HTTPMethod, FuzzerException, CFGTuple, CFG,get_logger
...
debug_logger = get_logger("debug_kzy_len","")#kzy_code
...
class Node:
    def __init__(self,
        ...
        self._rce_confidence = RCEConfidence['NONE']
    ...
    @property
    def rce_confidence(self):
        return self._rce_confidence

    @rce_confidence.setter
    def rce_confidence(self, value: RCEConfidence) -> Node:
        self._rce_confidence = value
        # force refresh of json
        self.__dict__.pop('_json',None)
    ...
    def parse_instrumentation(self, 
        ...
        #debug_logger.info(len(cfg_xor))
        #debug_logger.info(len(cfg_single))
    ...
    def __getstate__(self) -> Dict[str, Any]:
        ...
        state['rce_confidence'] = self.rce_confidence.name
