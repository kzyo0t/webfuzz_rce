...
debug_logger = get_logger("len_node_list","")#kzy_code
...
class NodeIterator:
    ...
    def total_cover_score(self):
        ...
        #debug_logger.info(total_count)
        #debug_logger.info(len(total_cfg))
    ...
    def _add_node_to_total_cfg(self, new_node: Node, local_cfg: CFG) -> None:
        ...
        #debug_logger.info("_add node to total cfg")
        ...
        for label, bucket in local_cfg.items():
            ...
            if existing_node is None:
                ...
                #debug_logger.info(new_node)
                #debug_logger.info(existing_node)
    ...
    def add(self, new_node: Node, node_cfg: CFGTuple):
        ...
        if env.instrument_args.policy == Policy.NODE:
            #debug_logger.info("newnode single")
            self._add_node_to_total_cfg(new_node, node_cfg.single_cfg)
        else:
            #45456ec4rf5tg rfvtgbhfvtgbh rvtgb6yhb6h7uj8ko.info("newnode xor_cfg")
        ...
        if new_node.ref_count == 0:
            ...
            #debug_logger.info("%s",self.node_list)
    ...
    def __next__(self):
        ...
        #debug_logger.info(len(self.node_list))
